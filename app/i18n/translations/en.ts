...
**It is therefore essential to involve all stakeholders—citizens, businesses, and public institutions—in the energy transition.**`,
	...
	"chart.infoDialog.heatingMix2021Summarized.learnMoreLink":
		"climate-concepts/",
	"chart.infoDialog.heatingMix2021Summarized.description": `The heating mix in Xhain shows that **heat supply is currently predominantly based on natural gas and district heating.** Therefore, in addition to reducing heat consumption, decarbonizing heat supply—meaning the transition to a climate-friendly heating system—is a key measure to reduce heat-related emissions.
...
To implement the Paris targets locally, the so-called remaining budget approach is used. This emphasizes that not only annual CO2 emissions are crucial but also the total amount of greenhouse gases released into the atmosphere over time.`,
	...
	"chart.infoDialog.reductionPathScenario175Thg.learnMoreLink":
		"climate-concepts/",
	"chart.infoDialog.reductionPathScenario175Thg.description": `**In recent years, we have failed to meet Berlin's climate protection targets.** To get back on track by 2030, we need to reduce emissions more significantly and take decisive action.
